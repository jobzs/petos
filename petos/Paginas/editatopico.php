                         ...
                         <?php 
                            ...
                            <form action="../Forms/processaTodosFormularios.php?idtopico=<?php echo $_GET['idtopico']; ?>" method="POST">
                                ...
                                <select  class="form-control" name="tema">
                                    <option value="outros" autofocus>Outros</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" class="form-control" name="conteudo"><?php echo $registro->conteudo; }} ?></textarea>
                                </div>
                                <div class="form-group">
                                    <p><span class="require text-danger">*</span> - campo obrigatório</p>
                                </div>
                                <div class="form-group">
                                    <button name="acao" class="btn btn-info" value="Editar">
                                        Editar
                                    </button>
                                </div>
