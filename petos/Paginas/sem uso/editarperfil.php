...
<head>
    ...
    <link rel="stylesheet" href="../bootstrap/light-bootstrap-dashboard.css?v=2.0.0 " media="all">
    ...
    <div class="wrapper">
        <div class="sidebar" data-color="blue">
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="feed.php" class="simple-text">
                        PEToS
                    </a>
                </div>
                <ul class="nav">
...
<!--   Core JS Files   -->
<script src="../bootstrap/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
<script src="../bootstrap/js/core/popper.min.js" type="text/javascript"></script>
<script src="../bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
<script src="../bootstrap/js/plugins/bootstrap-switch.js"></script>
<!--  Chartist Plugin  -->
...
<script src="../bootstrap/js/light-bootstrap-dashboard.js?v=2.0.0 " type="text/javascript"></script>
